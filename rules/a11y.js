...
export default {
    ...
    rules: {
        ...
        // Eequire onClick be accompanied by onKeyUp/onKeyDown/onKeyPress
        ...
        // Require that onmouseover/onmouseout come with onfocus/onblur (keyboard-only users)
